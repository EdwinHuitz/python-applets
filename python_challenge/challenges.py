...
# - Write a function called ranges that accepts two integers as arguments and returns an array of integers starting with the first argument up to one less than the second argument.
# - The ranges function must be called with the first argument less than or equal to the second argument, otherwise return the string "First argument must be less than second".

# Examples:

# ranges(1,4) //=> [1,2,3]
# ranges(-2, 3) //=> [-2,-1,0,1,2]
# ranges(1,1) //=> []
# ranges(5,2) //=> "First argument must be less than second"
# -----------------------------------------------------------------
# Your solution for 06-ranges here:
...
# flatten( [1, [2, 3]] ); //=> [1, 2, 3]  (a new array) 

# flatten( [1, [2, [3, [4]]], 1, 'a', ['b', 'c']] ); //=> [1, 2, 3, 4, 1, 'a', 'b', 'c']
# -----------------------------------------------------------------
